...
*/
    ...
    glUniform1i(glGetUniformLocation(program, "texUnit1"), 1); // Texture unit 0
...
void display(void)
{
	...
	glUniformMatrix4fv(glGetUniformLocation(skyboxProgram, "mdlMatrix"), 1, GL_TRUE, skyboxModelMat.m);
